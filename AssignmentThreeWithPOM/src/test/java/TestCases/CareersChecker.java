...
public class CareersChecker extends BaseTest {
    ...
    public void careersInfoAssertion() {
        ...
        test = extent.createTest("Customer Service  Page Title Verification", "Customer Service Page Title Verification");
        ...
        try {
            ...
            test.fail("Assertion failed: Titles are not Matching...Looks like Customer Service page not loaded ->>> Expected: " + expectedTitle + ", Actual: " + actualPageTitle + ". Exception: " + e.getMessage()).addScreenCaptureFromPath(screenshotPath2);
