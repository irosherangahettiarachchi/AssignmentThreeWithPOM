...
public class CareersPage extends BaseTest {
    ...
    @FindBy(xpath = "//*[@id=\"glbfooter\"]/footer/ul/li[1]/a") // AboutEbay
    ...
    public String careersOperations() {
        ...
        try {
            ...
            startSearchJob.sendKeys("Customer Service" + Keys.ENTER);
            test = extent.createTest("Successfully Navigate to Customer Service Jobs Page", "Successfully Navigate to Customer Service Jobs Page");
            String screenshotPath5 = TakeErrorScreenShots.takeScreenshot(driver, "Customer Service Jobs Page");
            test.pass("System Successfully Navigate to Customer Service Jobs Page").addScreenCaptureFromPath(screenshotPath5);
